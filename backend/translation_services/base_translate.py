...
class QualityMetrics(BaseModel):
    ...
    fluency_score: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="How natural/fluent the translation sounds (0-1)",
        example=0.92
    )
    ...
    accuracy_score: float = Field(
        ...
        ge=0.0,
        le=1.0, 
        description="How accurately meaning is preserved (0-1)",
        example=0.95
    )
    ...
    consistency_score: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="Consistency with previous translations (0-1)",
        example=0.88
    )
    ...
    overall_score: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="Combined quality score (0-1)",
        example=0.91
    )
    ...
    confidence: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="System confidence in translation (0-1)",
        example=0.89
    )
